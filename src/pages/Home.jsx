...
function Home() {
    ...
    const publications = [
    {
        ...
        abstract: "This study explores deep learning architectures for medical image classification and their impact on diagnostic accuracy."
    },
    {
        ...
        abstract: "A scalable decentralized framework for secure and transparent academic manuscript workflows."
    },
    {
        ...
        abstract: "An intelligent reviewer allocation model that improves review time and fairness."
    }
];
    ...
    return (
        <div>
            ...
            <section className="fade-section" style={sectionLight}>
                ...
                <p style={sectionText}>
                    Our system streamlines manuscript submission, peer review,
                    editorial decisions, and publication workflows. Designed for
                    authors, reviewers, and editors, the platform ensures transparency,
